        ...
        try:
            ...
            shaped = {
                ...
                'options': {
                    ...
                    'american_lsm': _s(_price(opts.get('american_lsm', 0))),
                    'american_lsm_se': _s(float(opts['american_lsm'].get('se',0)) if isinstance(opts.get('american_lsm'),dict) else 0),
                    'american_early_ex': _s(float(opts['american_lsm'].get('early_ex_premium',0)) if isinstance(opts.get('american_lsm'),dict) else 0),
                },
